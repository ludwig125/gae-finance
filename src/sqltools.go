...
// 		log.Infof(ctx, "code %s, date %s, 3: %f, 5: %f, 7: %f, 10: %f, 20: %f, 60: %f, 100 %f", code, date, mvavg[3][date], mvavg[5][date], mvavg[7][date], mvavg[10][date], mvavg[20][date], mvavg[60][date], mvavg[100][date])
